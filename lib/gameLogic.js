...
function resolveBatterPlay(room, payload) {
  ...
  g.lastResult = {
    ...
    hung: result.hung,
    grade,
    pitcherChoice: { typeId: g.pendingPitch.typeId, targetX: g.pendingPitch.targetX, targetY: g.pendingPitch.targetY, shift, grade, release: g.pendingPitch.release ?? null, releaseZone: g.pendingPitch.releaseZone ?? null },
    batterChoice: { mode, batX, batY, swingDelta, steal: steal ? steal.base : null, contactQuality: result.contactQuality, timingLabel: timingLabelOf(result.contactQuality) },
